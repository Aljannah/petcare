            ...
            <div class="wrapper">
                ...
                <section id="content">
                    ...
                    <div class="container">
                        ...
                        <hr>
<!--                        <form action="<?php echo base_url("index.php/category/matic")?>" method="POST">
                                    ...
                                    <div id="profile-page-sidebar" class="col s12 m3">
                                        ...
                                        <ul id="profile-page-about-details" class="collection z-depth-1">
                                            <li class="collection-item">
                                                <button onclick="location.href='<?php echo base_url("index.php/con_home/paket_anjing/".$pesan -> user_partners)?>';" type="button" class="btn btn-cart">
                                                    Pilih
                                                </button>
                                            </li>
