...
<html>
<head>
<title>Motive Mag a Entertainment Category Flat Bootstrap Responsive Website Template | Contact :: w3layouts</title>
...
<link href="<?php base_url();?>assets/css/bootstrap-3.1.1.min.css" rel="stylesheet" type="text/css">
<!-- Custom Theme files -->
		   ...
		   <div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
				    ...
				    <li class="dropdown">
						<a href="entertainment.html" class="dropdown-toggle" data-toggle="dropdown">Entertainment<b class="caret"></b></a>
					...
					<div class="footer-grids">
						...
						<h4>EDITOR PICKS</h4>
						  <div class="editor-pics">
							 <div class="col-md-3 item-pic">
							   <img src="<?php base_url();?>assets/images/f1.jpg" class="img-responsive" alt=""/>
							 ...
							 <div class="editor-pics">
							 <div class="col-md-3 item-pic">
							   <img src="<?php base_url();?>assets/images/f2.jpg" class="img-responsive" alt=""/>
							 ...
							 <div class="editor-pics">
							 <div class="col-md-3 item-pic">
							   <img src="<?php base_url();?>assets/images/f3.jpg" class="img-responsive" alt=""/>
						...
						<div class="col-md-4 footer-grid">
							<h4>POPULAR POSTS</h4>
								<div class="editor-pics">
										 <div class="col-md-3 item-pic">
										   <img src="<?php base_url();?>assets/images/f4.jpg" class="img-responsive" alt=""/>
...
<!--JS-->
  <script type="text/javascript" src="<?php base_url();?>assets/js/bootstrap-3.1.1.min.js"></script>
