 <div class="footer-section" style="padding-bottom: 0px; width: 1350px;">
         ...
         <div class="container">
                   ...
                   <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 footer_logo" >
                       <center>
                           <figure>
                               <img src="<?php echo base_url("icon/choices.png")?>" width="100px" height="100px">
                               <figcaption>Pilih jenis hewan dan paket yang diinginkan</figcaption>
                           </figure>
                       </center>
                   </div> <!-- End of .footer_logo -->
                   ...
                   <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 footer_logo" >
                       <center>
                           <figure>
                               <img src="<?php echo base_url("icon/if_calendar_1291765.png")?>" width="100px" height="100px">
                               <figcaption>Tentukan tanggal untuk dilakukan grooming</figcaption>
                           </figure>
                       </center>
                   </div> <!-- End of .footer_logo -->
                   ...
                   <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 footer_logo" >
                       <center>
                           <figure>
                               ...
                               <figcaption>Tunggu konfirmasi dari Penyedia Jasa Grooming</figcaption>
                           </figure>
                       </center>
                   </div> <!-- End of .footer_logo -->
                   ...
                   <div class="col-lg-2 col-md-6 col-sm-6 col-xs-12 footer_logo" >
                       <center>
                           <figure>
                               <img src="<?php echo base_url("icon/if_buy-bill-money-cash-pay_2205221.png")?>" width="100px" height="100px">
                               <figcaption>Lakukan pembayaran ditempat</figcaption>
                           </figure>
                       </center>
                   </div> <!-- End of .footer_logo -->
...
<!--//JS-->
        ...
        <script src="<?php echo base_url();?>assets3/scripts/jquery-1.9.1.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>assets3/scripts/jquery-ui-1.10.1.custom.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>assets3/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>assets3/scripts/flot/jquery.flot.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>assets3/scripts/flot/jquery.flot.resize.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>assets3/scripts/datatables/jquery.dataTables.js" type="text/javascript"></script>
        <script src="<?php echo base_url();?>assets3/scripts/common.js" type="text/javascript"></script>
</body>
</html>
