                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td align="center"><?=  $events->status ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php else:?>
                                                            <?=  anchor('admin/event/delete/'.$events->id_petgrooming,'Delete',['class'=>'btn btn-danger btn-xs','data-toggle'=>'button','onclick'=>'return confirm(\'Anda Yakin Menghapus Event ? \')']) ?>
                                                            <?php endif;?>
