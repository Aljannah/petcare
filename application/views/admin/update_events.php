 ...
 <?php $this->load->view('layout/headeradmin')?> 
                    ...
                    <div class="span9">
                        <div class="content">
                            ...
                            <?php echo form_open_multipart('admin/event/edit/'.$id_petgrooming,['class'=>'your-para']);?>
                            ...
                            <input type="text" name="package_name" value="<?= $package_name ?>"readonly>
                            
                            <?php echo form_error('description'); ?>
                            <p class="your-para">Deskripsi Paket :</p>
                            <textarea cols="100" rows="10" name="description" readonly><?= $description ?></textarea>
                            
                            <?php echo form_error('petcategory'); ?>
                            <p class="your-para">Kategori Grooming :</p>
                            <div class="controls">
                            <select name="petcategory" readonly>
                              <option value="<?= $petcategory ?>"><?= $petcategory ?></option>
                              <option value="Anjing">Sportainment</option>
                              <option value="Kucing">Competition</option>
