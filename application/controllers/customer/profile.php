...
class Profile extends CI_Controller {
	...
	{	
		...
		$data['profile'] = $this->model_allpenggunas->lihat_profile_customer();	
		$this->load->view('customer/lihat_profile_customer',$data);
...
/*
	...
	public function edit_biodata($username){
		...
		if ($this->form_validation->run() == FALSE)	{
				$data['profile'] = $this->model_allpenggunas->find_customer($username);
				$this->load->view('customer/update_profile_customer',$data);
			} else {
				if($_FILES['userfile']['name'] != ''){
						...
						if($this->input->post('password')==""){
							$data_customer = array(
								...
								$data_dicustomer = array(
									'password'                   => md5($password));
								$this->model_allpenggunas->edit_password_customer($username,$data_dicustomer);
							}

							$this->model_allpenggunas->edit_biodata_customer($username,$data_customer);
